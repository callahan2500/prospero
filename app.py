...
def ask():
    ...
    message_content = request.json['user_message']
    assistant= "asst_IQYGdRwWaUSiIqi3HmzwiZOf"
    ...
    user_run = wait_on_run(run, thread)
    messages =  openai.beta.threads.messages.list(thread_id=thread.id, order="asc")
    print(messages)
